---
title: "Assistent multiagent: un model/API per funció"
linkTitle: "0009-assistant-multiagent"
weight: 90
description: Generat automàticament des de docs/adr/0009-assistant-multiagent.md. No editis aquest fitxer directament.
---
