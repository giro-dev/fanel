---
title: "SPA React + TypeScript (PWA) servida des del JAR"
linkTitle: "0002-spa-react-embeguda"
weight: 20
description: Generat automàticament des de docs/adr/0002-spa-react-embeguda.md. No editis aquest fitxer directament.
---
