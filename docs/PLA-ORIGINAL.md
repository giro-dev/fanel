...
> d'arquitectura vinculants viuen a [`AGENTS.md`](../AGENTS.md) i als [ADRs](adr/); l'estat
> real d'implementació viu a [`ROADMAP.md`](ROADMAP.md). Si aquest document i el `ROADMAP.md`
